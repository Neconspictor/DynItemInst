...
instance ITWR_EISZAUBER(C_Item)
{
	name = "Eisverzauberung";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MULTI;
	value = 200;
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = useeiszauber;
	scemeName = "MAP";
	description = name;
	text[1] = "Die Eisverzauberung vereint die Kraft des Stahls mit der Kraft des Eises.";
	text[2] = "Anwendbar auf die getragene Nah- oder Fernkampfwaffe.";
	text[3] = "Eisschaden-Bonus:";		count[3] = MAGICWEAPON_BonusDamage;
	text[5] = NAME_VALUE; 				count[5] = value;
};


func void useeiszauber()
{
	ZAUBERART = 2;
	AI_ProcessInfos (hero);
};
...
instance ITWR_PoisonMagic(C_Item)
{
	name = "Giftverzauberung";
	mainflag = ITEM_KAT_DOCS;
	flags = ITEM_MULTI;
	value = 200;
	visual = "ItWr_Scroll_01.3DS";
	material = MAT_LEATHER;
	on_state[0] = usePoisonMagic;
	scemeName = "MAP";
	description = name;
	text[1] = "Die Giftverzauberung vereint die Kraft des Stahls mit der schleichenden Kraft des Giftes.";
	text[2] = "Anwendbar auf die getragene Nah- oder Fernkampfwaffe.";
	text[3] = "Fügt ein schwaches Gift hinzu.";
	text[5] = NAME_VALUE; 	count[5] = value;
};


func void usePoisonMagic()
{
	ZAUBERART = 3;
	AI_ProcessInfos (hero);
};
...
INSTANCE StandardBrief		(C_Item)
{
	...
	DIFFICULTY_SETTINGS_configureWeaponStats();
};
