...
instance FIRE_SWORD_ICE(FIRE_SWORD_PROTO)
{
	//visname_s = "HUMANBURN_ICE.TGA";
};
instance FIRE_SWORD_FLAME(FIRE_SWORD_PROTO)
{
	//visname_s = "LOA_FLAME.TGA";
};

prototype POISON_SWORD_PROTO(C_PARTICLEFX)
{
	ppsvalue = 150;
	ppsscalekeys_s = "1.0";
	ppsislooping = 1;
	...
	lsppartavg = 300;
	flygravity_s = "0 0.0003 0";
	//visname_s = "HumanBurngreenmagic.TGA";
	visorientation_s = "VELO";
	vistexisquadpoly = 1;
	vistexanifps = 15;
	vistexaniislooping = 1;
...
instance POISON_SWORD(POISON_SWORD_PROTO)
{
};
