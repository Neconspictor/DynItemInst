...
public:
	 ...
	 */
	static void __thiscall oCItemInitByScript (oCItem* item, int inst, int second);
	 ...
	 */
	void setInstanceId(oCItem* item, int value);
...
private:
	...
	/**
	 * Creates a new object manager. Private constructor because this class is a singleton.
	 */
	ObjectManager();
